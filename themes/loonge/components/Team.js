          ...
          <div className='flex flex-col md:flex-row -mx-4 justify-between'>
            ...
            <div className='flex flex-col px-4 space-y-4 mx-auto justify-between max-w-[485px]'>
              ...
              <div className='grid grid-cols-2 grid-rows-2 pt-6 gap-4'>
                <KeyVal
                  k={siteConfig('PROXIO_ABOUT_KEY_1')}
                  v={siteConfig('PROXIO_ABOUT_VAL_1')}
                />
                <KeyVal
                  k={siteConfig('PROXIO_ABOUT_KEY_2')}
                  v={siteConfig('PROXIO_ABOUT_VAL_2')}
                />
                <KeyVal
                  k={siteConfig('PROXIO_ABOUT_KEY_3')}
                  v={siteConfig('PROXIO_ABOUT_VAL_3')}
                />
                <KeyVal
                  k={siteConfig('PROXIO_ABOUT_KEY_4')}
                  v={siteConfig('PROXIO_ABOUT_VAL_4')}
                />
              </div>
