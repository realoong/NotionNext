    ...
    <>
      ...
      <section className='relative overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]'>
        <div className='max-w-2xl mx-auto wow fadeInUp' data-wow-delay='.2s'>
          ...
          {/* FAQ 列表 */}
          <div
            className='-mx-4 flex flex-wrap space-y-4 wow fadeInUp'
            data-wow-delay='.2s'
          >
            {FAQS?.map((faq, index) => (
              <div
              ...
              >
                <div className='p-4 border rounded-lg dark:bg-[#0E0E0E] bg-white dark:bg-dark-1 border-gray-200 dark:border-[#333333]'>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <i
                      className={`fas fa-chevron-down text-gray-500 dark:text-gray-300 transition-transform duration-300 ${
                  ...
                  {/* 答案部分 */}
                  <div
                    className={`mt-4 text-base text-body-color dark:text-dark-6 transition-all duration-300 overflow-hidden ${
