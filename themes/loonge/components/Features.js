    ...
    <>
      ...
      <section className='pb-8 pt-20 dark:bg-dark lg:pb-[40px] lg:pt-[120px]'>
        <div className='container'>
          <div
            className='-mx-4 flex flex-wrap wow fadeInUp'
            data-wow-delay='.2s'
          >
          ...
          <div className='-mx-4 flex flex-col md:flex-row gap-4 px-4'>
            <div className='w-full p-6 rounded-xl border border-gray-200 dark:border-[#333333]'>
              <div
                className='wow fadeInUp group flex-col space-y-2 flex'
                data-wow-delay='.1s'
              >
                <div className='flex w-12 h-12'>
                  <div className='overflow-hidden w-full flex justify-center items-center rounded-xl border border-gray-200 dark:border-[#333333] dark:text-white'>
                    <i
                      className={
                        siteConfig('PROXIO_FEATURE_1_ICON_CLASS') + ' absolute'
                      }
                    ></i>
                    <LazyImage
                      src={siteConfig('PROXIO_FEATURE_1_ICON_IMG_URL')}
                      className='z-10'
                    />
                  </div>
                </div>
              ...
              >
                <div className='flex w-12 h-12'>
                  <div className='overflow-hidden w-full flex justify-center items-center rounded-xl border border-gray-200 dark:border-[#333333] dark:text-white'>
                    ...
                    <LazyImage
                      src={siteConfig('PROXIO_FEATURE_2_ICON_IMG_URL')}
                      className='z-10'
                    />
                  </div>
                </div>
              ...
              >
                <div className='flex w-12 h-12'>
                  <div className='overflow-hidden w-full flex justify-center items-center rounded-xl border border-gray-200 dark:border-[#333333] dark:text-white'>
                    ...
                    <LazyImage
                      src={siteConfig('PROXIO_FEATURE_3_ICON_IMG_URL')}
                      className='z-10'
                    />
                  </div>
                </div>
