...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'loonge', // 110216.xyz V2 默认使用独立的个人主页主题
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.svg', // blog favicon 配置, 默认使用个人站点图标
